...
public partial class LicenseAgreementWindow : Window
{
    ...
    {
        InitializeComponent();
        Debug.WriteLine("[LicenseAgreementWindow] Initializing license agreement window.");
        LoadLicenseText();
    }

    private void LoadLicenseText()
    {
        LicenseTextBox.Text = @"PolyForm Noncommercial License 1.0.0
...
""Use"" means anything you do with the software requiring one of your licenses.";
    ...
    {
        Debug.WriteLine("[LicenseAgreementWindow] License accepted.");
        LicenseAccepted = true;

        SettingsService.Settings.LicenseAccepted = true;
        SettingsService.Settings.LicenseAcceptedDate = DateTime.UtcNow;
    ...
    {
        Debug.WriteLine("[LicenseAgreementWindow] License declined.");
